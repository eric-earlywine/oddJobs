  ...
  describe('NewUser Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NewUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.newUsers && comp.newUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
